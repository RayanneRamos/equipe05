...
import { CalendarDaysIcon, CheckIcon, XMarkIcon, ChevronDownIcon, EnvelopeIcon } from "@heroicons/react/24/outline";
            ...
            <div className="w-full flex flex-col xl:w-[68.2rem] items-center gap-[2.5rem] text-white py-[2.1rem] px-[2.6rem] xl:py-[4.1rem] xl:px-[4.6rem] rounded-[2.4rem] bg-[#111114]">
                ...
                <form className="w-full flex flex-col gap-[2.5rem]">
                    <div className="flex flex-col gap-[1.5rem] xl:gap-[2.5rem]">
                        <div className="flex-col flex gap-[1.5rem] xl:flex-row xl:gap-[3.2rem]">
                            <div className="flex flex-col w-full">
                                <label className="text-[1.6rem]" htmlFor="nome">Nome*</label>
                                <input
                                    type="text"
                                    id="nome"
                            ...
                            <div className="flex flex-col w-full">
                                <label className="text-[1.6rem]" htmlFor="sobrenome">Sobrenome*</label>
                                <input
                                    type="text"
                                    id="sobrenome"
                                    className="w-full rounded-[0.8rem] mt-[0.4rem] xl:mt-[1.2rem] p-[1.0rem] xl:p-[1.2rem] gap-[1.0rem] border-[0.1rem] border-[#525252] outline-none bg-transparent text-[1.6rem]"
                        ...
                        <div className="flex-col flex gap-[1.5rem] xl:flex-row xl:gap-[3.2rem]">
                            ...
                            <div className="flex flex-col w-full">
                                <label className="text-[1.6rem]" htmlFor="whatsapp">Whatsapp*</label>
                            ...
                            <div className="flex flex-col w-full">
                                <label className="text-[1.6rem]" htmlFor="email">Email*</label>
                        ...
                        <div className="flex-col flex gap-[1.5rem] xl:flex-row xl:gap-[3.2rem]">
                            ...
                            <div className="flex flex-col w-full">
                                <label htmlFor="area-de-interesse" className="mb-[0.4rem] xl:mb-[1.2rem] text-[1.6rem]">Área de interesse*</label>
                                <div className="relative">
                                    ...
                                    >
                                        <option value="" hidden disabled className="bg-[#111114] text-white">Selecione uma opção</option>
                            ...
                            <div className="flex flex-col w-full">
                                <label htmlFor="linguagem" className="mb-[0.4rem] xl:mb-[1.2rem] text-[1.6rem]">Linguagem</label>
                                <div className="relative">
                                    <select
                                        id="linguagem"
                                        defaultValue=""
                        ...
                        <div className="flex-col flex gap-[1.5rem] xl:flex-row xl:gap-[3.2rem]">
                            <div className="flex flex-col w-full relative">
                                <label htmlFor="data" className="mb-[0.4rem] xl:mb-[1.2rem] text-[1.6rem]">Disponibilidade*</label>
                                <input
                                    type="date"
                                    id="data"
                                    className="w-full
                                ...
                                />
                                <CalendarDaysIcon
                                    className="absolute left-[1.2rem] top-[60%] xl:top-[65%] w-5 h-5 text-[#A3A3A3] cursor-pointer"
                                />
                            </div>

                            <div className="flex flex-col w-full">
                                <label htmlFor="turno" className="mb-[0.4rem] xl:mb-[1.2rem] text-[1.6rem]">Turno</label>
                                <div className="relative">
                                    <select
                                        id="turno"
                                        defaultValue=""
                                        className="w-full rounded-[0.8rem] p-[1.0rem] xl:p-[1.2rem] gap-[1.0rem] border-[0.1rem] border-[#525252] outline-none bg-transparent text-white cursor-pointer appearance-none text-[1.6rem]"
                                    >
                                        <option value="" hidden disabled className="bg-[#111114]">Selecione uma opção</option>
                                        <option value="Manhã" className="bg-[#111114]">Manhã</option>
                                        <option value="Tarde" className="bg-[#111114]">Tarde</option>
                                        <option value="Noite" className="bg-[#111114]">Noite</option>
                                    </select>
                                    <span className="absolute inset-y-0 right-0 flex items-center px-4 pointer-events-none">
                                        <ChevronDownIcon className="w-[1.2rem]" />
                                    </span>
                    ...
                    <div className="flex w-full">
                        ...
                        <label htmlFor="aceitar-termos" className="w-[55.8rem] text-[1.4rem] leading-[2.1rem] font-manrope text-[#A3A3A3]">
                            Declaro que li e concordo com os <span className="text-white font-bold">Termos e Condições</span> e com a <span className="text-white font-bold">Política de Privacidade</span> da Código certo coders.
                        </label>
                    </div>
                    <div className="flex w-full justify-end font-bold gap-[0.8rem] text-[1.4rem]">
                        <button className="flex px-[3.2rem] py-[0.4rem] rounded-[0.8rem] text-[#A3A3A3] border border-[#A3A3A3]" type="submit">
                            <p className="flex items-center justify-center h-[3.2rem]">Fechar</p>
                        </button>
                        <button className="flex px-[3.2rem] py-[0.4rem] rounded-[0.8rem] text-black bg-[#FFFFFF] border border-[#FFFFFF]" type="submit">
                            <p className="flex items-center justify-center h-[3.2rem]">Enviar</p>
                        </button>
                    </div>
                </form>
            </div>
